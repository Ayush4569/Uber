...
const VehiclePanel = ({setConfirmRidePanel,setVehicleOpenPanel}) => {
  return (
    <>
         <h5 className="p-1 text-center w-[93%] absolute top-1" onClick={()=>{setVehicleOpenPanel(false)}}>
        <i className="text-3xl text-gray-700 ri-arrow-down-wide-fill" ></i>
        </h5>
        <h3 className="text-2xl font-semibold mb-5">Choose a vehicle</h3>
           <div onClick={()=>{setConfirmRidePanel(true),setVehicleOpenPanel(false)}} className="flex p-3 w-full items-center border-2 mb-2 active:border-black rounded-xl justify-between">
