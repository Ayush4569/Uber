         ...
         <h5 className='p-1 text-center w-[93%] absolute top-0' onClick={() => {
            ...
            <div className='flex items-center justify-between p-3 rounded-lg bg-yellow-300 mt-4'>
                <div className='flex items-center justify-between gap-3'>
                    <img className='h-12 w-12 rounded-full object-cover' src="https://preview.redd.it/created-random-people-using-chatgpt-midjourney-do-you-know-v0-q1aa450i5dqb1.png?width=1024&format=png&auto=webp&s=c4e9abc47d193474a2fa1a7e337d9d9340dce947" />
